...
# --- معجم الترادف الشامل والمطابق لملف الإكسل الجديد ---
COMMON_SYNONYMS = {
    # المقاهي والمطاعم والحلويات
    "كوفي": "مقاهي", "كوفيه": "مقاهي", "قهوه": "مقاهي", "قهوة": "مقاهي", "كافيه": "مقاهي",
    "اكل": "مطاعم", "أكل": "مطاعم", "جوع": "مطاعم", "غدا": "مطاعم", "عشا": "مطاعم", "مطعم": "مطاعم",
    "حلا": "حلويات وآيس كريم", "حلوى": "حلويات وآيس كريم", "ايسكريم": "حلويات وآيس كريم", "ايس كريم": "حلويات وآيس كريم",
    "بن": "محمصة", "قهوة سوداء": "محمصة",
    
    # الملابس والأزياء واللانجري
    "لبس": "ملابس", "ازياء": "ملابس", "أزياء": "ملابس", "فستان": "ملابس", "فساتين": "ملابس",
    "عبايه": "عبايات", "ملافع": "عبايات",
    "بجامه": "لانجري وملابس داخلية", "بجامات": "لانجري وملابس داخلية", "داخلي": "لانجري وملابس داخلية",
    
    # العطور، التجميل، الحقائب، الاكسسوارات
    "مكياج": "عطور وتجميل", "ميكب": "عطور وتجميل", "ميك أب": "عطور وتجميل", "عطر": "عطور وتجميل",
    "ذهب": "اكسسوارات و مجوهرات", "فضه": "اكسسوارات و مجوهرات", "ساعه": "اكسسوارات و مجوهرات", "ساعات": "اكسسوارات و مجوهرات",
    "شنطه": "حقائب و أحذية", "شنط": "حقائب و أحذية", "شوز": "حقائب و أحذية", "شوزات": "حقائب و أحذية", "جزمة": "حقائب و أحذية",
    
    # المنزل، الرياضة، الاتصالات، الترفيه، والحضانة (تحديث المطابقة مع ملفكِ)
    "اثاث": "منزل", "أثاث": "منزل", "كنب": "منزل", "فرش": "منزل", "طاوله": "منزل", "طاولات": "منزل",
    "جم": "رياضة", "جيم": "رياضة", "ملابس رياضية": "رياضة", "كوره": "رياضة",
    "جوال": "اتصالات", "جوالات": "اتصالات", "شحن": "اتصالات", "موبايلي": "اتصالات", "زين": "اتصالات", "stc": "اتصالات",
    "فيلم": "سينما", "افلام": "سينما", "أفلام": "سينما", "موجه": "سينما",
    "لعب": "ترفيه والعاب", "العاب": "ترفيه والعاب", "ألعاب": "ترفيه والعاب", "ملاهي": "ترفيه والعاب",
    "حضانه": "حضانة", "بيبي ستر": "حضانة", "رعاية أطفال": "حضانة", "مكان للاطفال": "حضانة",
    
    # الخدمات اليومية
    "بنده": "سوبرماركت", "تموينات": "سوبرماركت", "مقاضي": "سوبرماركت",
    "علاج": "صيدليات", "دوا": "صيدليات", "دواء": "صيدليات", "صيدليه": "صيدليات"
}
...
def get_bot_response(user_query, data):
    ...
    # تحديد نية البحث بدقة لتخصيص العناوين
    ...
    is_entertainment = any(w in final_search_words for w in ["ترفيه والعاب"])
    ...
    if matched_shops:
        ...
        if is_food:
            ...
            header = f"🎡 **إليكِ مراكز الترفيه والألعاب المتوفرة{floor_text}:**"
